...
class PatientStateMonitor:
    ...
    def update(self, k, next_state):
        ...
        if next_state is P.HealthStats.STOKE_DEATH or P.HealthStats.NON_STROKE_DEATH:
    ...
    def get_if_alive(self):
        result = True
        if self._currentState == P.HealthStats.STOKE_DEATH or P.HealthStats.NON_STROKE_DEATH:
            result = False
        return result
